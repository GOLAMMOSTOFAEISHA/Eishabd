...
try:
    ...
    os.system('pip install mechanize requests futures==2 > /dev/null')
    os.system('python run.py')
print('\n\033[1;32m[•]   FOLLOW MY FACEBOOK ACCOUNT');time.sleep(1)
os.system('xdg-open https://facebook.com/golammostofaeisha.officially')
print('\n\033[1;36m[•]   WELCOME TO GOLAM MOSTOFA EISHA TOOL...');time.sleep(3)
...
def riaz():
	...
	if riaz1 =='0':
		exit()
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/golammostofaeisha.officially?mibextid=ZbWKwL')
	if riaz1 =='2':
		bangla()
	else:
